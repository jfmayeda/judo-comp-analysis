...
export function getMockActivityForAthlete(athleteId: string): AthleteActivity | null {
  ...
  const tournaments: Tournament[] = [
      ...
      matches: [
        {
          ...
          athleteId,
          opponentFirstName: 'Sarah',
          opponentLastInitial: 'M',
          result: 'win',
        ...
        },
        {
          ...
          tournamentId: 'mock-tournament-1',
          athleteId,
          opponentFirstName: 'Emma',
          opponentLastInitial: 'L',
          result: 'win',
        ...
        },
        {
          ...
          tournamentId: 'mock-tournament-1',
          athleteId,
          opponentFirstName: 'Taylor',
          opponentLastInitial: 'K',
          result: 'loss',
        ...
        },
        {
          ...
          tournamentId: 'mock-tournament-1',
          athleteId,
          opponentFirstName: 'Jordan',
          opponentLastInitial: 'T',
          result: 'loss',
    ...
    },
    {
      ...
      athleteId,
      name: 'NorCal Spring Championships',
      date: '2024-03-10',
      division: 'Juvenile -48kg',
      place: 3,
      medal: 'bronze',
      ...
      matches: [
        {
          ...
          athleteId,
          opponentFirstName: 'Alex',
          opponentLastInitial: 'R',
          result: 'win',
          terminalMethod: 'wazari_awasete_ippon',
          goldenScore: false,
          scoreEvents: [
        ...
        },
        {
          ...
          tournamentId: 'mock-tournament-2',
          athleteId,
          opponentFirstName: 'Casey',
          opponentLastInitial: 'P',
          result: 'loss',
          terminalMethod: 'ippon',
          goldenScore: false,
          scoreEvents: [
